...
param_grid = {
    "clf__C": [0.001, 0.01, 0.1, 1.0],   # moderate C values
    # optionally:
...
print("\n===== Hyperparameter search with 5-fold CV on train+val (Linear SVM) =====")
...
for feat_name, X_fs in feature_sets.items():
    ...
    print("  Retraining best LinearSVC on full train+val...")
    ...
    test_scores = clf.decision_function(X_test_fs)
...
print("\n===== Summary across feature sets (Linear SVM) =====")
...
print("\n===== BEST FEATURE SET (by TEST ROC-AUC, Linear SVM) =====")
